...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\asv_description\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/asv_description/local_setup.bat"
