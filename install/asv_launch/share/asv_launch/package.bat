...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\asv_launch\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\asv_launch\hook\ament_prefix_path.bat"
