...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ros_tcp_endpoint\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\ros_tcp_endpoint\hook\ament_prefix_path.bat"
